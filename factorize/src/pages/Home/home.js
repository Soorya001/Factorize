   ...
   console.log('time is: ',currentTime)   
    ...
    return <>
        ...
        <div className="container">
            ...
            <ul class="nav nav-tabs bg-info bg-gradient rounded border-dark pt-2 p-1" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active text-dark " id="home-tab" data-bs-toggle="tab" data-bs-target="#twitter" type="button" role="tab" aria-controls="twitter" aria-selected="true">Twitter Link</button>
                </li>
                {/* <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-dark " id="profile-tab" data-bs-toggle="tab" data-bs-target="#news" type="button" role="tab" aria-controls="news" aria-selected="false">News Link</button>
                </li>   
            </ul>
